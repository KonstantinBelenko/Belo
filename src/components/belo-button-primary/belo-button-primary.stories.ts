 ...
 */
const Template = (args) => `
  <belo-button-primary disabled="${args.disabled}" pill="${args.pill}">${args.text}</belo-button-primary>
`;
 ...
 */
export const BeloButtonPrimary = Template.bind({});
BeloButtonPrimary.args = {
  text: 'Label',
  disabled: false,
  pill: false,
};
